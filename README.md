This version supports additional filtering of growing fragments by pre-compiled db of 3D pharmacophore hashes for up to 5 feature combinations and fragments with up to 12 heavy atoms.
